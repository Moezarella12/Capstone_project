...
def get_dealer_details(request, dealer_id):
    context={}
    url = "bluemix.cloudantnosqldb.appdomain.cloud/api/review"
    apikey="IMoB-rqmQk5JBPWaPIPWUH6AR97wMhZuA37I_s3FGxRP"
    #print(dealer_id)
    # Get dealers from the URL
...
def add_review(request, dealer_id):
    ...
    if request.method == 'GET':
        url = "bluemix.cloudantnosqldb.appdomain.cloud/api/dealership"
        # Get dealers from the URL
        context = {
            "dealer_id": dealer_id,
        ...
        if (request.user.is_authenticated):
            ...
            json_result = post_request("bluemix.cloudantnosqldb.appdomain.cloud/api/review", review, dealerId=dealer_id)
            print(json_result)
